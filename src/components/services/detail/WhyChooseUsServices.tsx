...
export default function WhyChooseUsServices({ features }: WhyChooseUsProps) {
  return (
      ...
      <div className="container-custom">
        ...
        <div className="flex flex-col items-start text-left lg:items-center lg:text-center">
          ...
          <h2 className="heading-lg max-w-[720px]">
            Why Choose{" "}
            <span className="text-[#E53935]">TerraForma Drilling?</span>
          </h2>
        </div>
              ...
              {features.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="font-heading mb-4 max-w-[320px] text-[20px] font-semibold leading-[28px] tracking-[0.6px] text-[#1A1917]">
                      {item.title}
                    </h3>

                    <p className="body max-w-[320px] text-center">
                      {item.description}
                    </p>
                  </div>
                );
