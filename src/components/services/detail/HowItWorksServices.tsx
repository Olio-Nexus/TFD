    ...
    <section className="bg-[#F4F1EB] py-12 md:py-20">
      <div className="container-custom">
        ...
        <div className="max-w-[1280px]">
          ...
          <h2 className="font-heading max-w-[666px] text-[24px] font-semibold leading-[30px] tracking-[-1px] text-[#1A1917] md:text-[48px] md:leading-[56px] md:tracking-[-2px]">
            From Scope to{" "}
            <span className="text-[#E53935]">Site Mobilisation</span>
          </h2>
          ...
          {steps.map((step) => (
            <div key={step.number} className="flex gap-4">
              <div className="flex w-9 flex-col items-center">
                ...
                {/* Line under EVERY number including 04 */}
                <div className="mt-2">
                  <MobileLine />
                </div>
              </div>
