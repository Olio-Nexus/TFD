  ...
  return (
    <section className="relative overflow-hidden bg-[#1A1917] pt-[72px]">
      ...
      <div className="relative z-10 hidden min-h-[602px] flex-col items-center justify-center px-[80px] py-[120px] lg:flex">
        ...
        <div className="mt-8 flex w-full max-w-6xl flex-col items-center gap-8">

          <div className="flex flex-col items-center gap-5">

            <h1 className="text-balance text-center font-heading text-[56px] font-semibold leading-[64px] tracking-[-2px] text-white">
              {parts[0]}
          ...
          <div className="flex gap-5">
            ...
            <Link href="/services" className="btn-glass h-[44px] min-w-[198px] text-[16px]">
              View Services
            </Link>
          </div>
