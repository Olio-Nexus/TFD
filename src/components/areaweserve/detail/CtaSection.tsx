...
function DesktopWave() {
  return (
    <svg
      ...
      aria-hidden
    >
      <g opacity="0.5" clipPath="url(#area-cta-wave-clip-desktop)">
        <path
          opacity="0.85"
      ...
      <defs>
        <clipPath id="area-cta-wave-clip-desktop">
...
function MobileWave() {
  return (
    <svg
      ...
      aria-hidden
    >
      <g opacity="0.6" clipPath="url(#area-cta-wave-clip-mobile)">
        <path
          opacity="0.85"
      ...
      <defs>
        <clipPath id="area-cta-wave-clip-mobile">
        ...
        <div className="mx-auto flex max-w-[838px] flex-col items-center gap-6 text-center md:gap-8">
          <div className="flex flex-col items-center gap-4 md:gap-5">
            <h2 className="text-balance font-heading text-[36px] font-semibold leading-[40px] tracking-[-1px] text-[#1A1917] md:text-[56px] md:leading-[64px] md:tracking-[-2.38px]">
              {parts[0]}
              {highlight && <span className="text-[#F53D37]">{highlight}</span>}
              {parts[1]}
            </h2>
